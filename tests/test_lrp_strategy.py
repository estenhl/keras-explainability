...
#     conv1_lrp = explainer.layers[24]
#     conv2_lrp = explainer.layers[21]
#     conv3_lrp = explainer.layers[18]
#     dense_lrp = explainer.layers[14]
...
def test_lrp_strategy_pooling():
    ...
    assert explainer.layers[22].strategy == PoolingLRPLayer.Strategy.FLAT
    assert explainer.layers[19].strategy == \
           PoolingLRPLayer.Strategy.REDISTRIBUTE
    assert explainer.layers[16].strategy == \
